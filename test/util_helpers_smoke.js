// util.promisify + util.types + util.isXxx: new-this-session util expansion.

var util = require("util");

function assert(c, msg) { if (!c) { console.error("FAIL:", msg); process.exit(1); } }

// util.promisify: Node-style callback -> Promise. Works under our
// synchronous Promise polyfill (callback fires during the call).
