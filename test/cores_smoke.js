...
// 8. child_process.execSync (sync). The async spawn is covered by
...
assert(typeof child.spawn === "function", "spawn is a function");
console.log("ok: child_process execSync (+spawn exposed)");
