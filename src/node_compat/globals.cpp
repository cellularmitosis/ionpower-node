...
static const char kBootstrapJS[] =
    ...
    "    else throw new Error('crypto: algorithm ' + alg + ' not supported (ionpower-node has sha256 + sha1 + md5 inline)');\n"
    "    this._chunks = [];\n"
    "  }\n"
    ...
    "    if (d !== 'sha256' && d !== 'sha1' && d !== 'md5') {\n"
    "      throw new Error('pbkdf2: digest ' + digest + ' not supported');\n"
    "    }\n"
    "    var blockSize = 64;\n"
    "    var hashSize = (d === 'md5') ? 16 : (d === 'sha1' ? 20 : 32);\n"
